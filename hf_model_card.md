...
基于 **Diffusion Transformer (DiT)** 和 **Flow Matching** 的多语言 Zero-Shot 文本到语音（TTS）模型。只需提供一小段参考音频，即可快速克隆任何人的声音。

💬 **开源代码仓库**：[Light-yzc/F5_like_TTS](https://github.com/Light-yzc/F5_like_TTS)
...
vocab_path = hf_hub_download(repo_id=repo_id, filename="char_vocab.json")

# 下载 VAE 和代码
vae_dir = snapshot_download(repo_id=repo_id, allow_patterns=["vae/*"])
